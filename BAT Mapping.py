...
os.chdir("C://Users//1510806//OneDrive - Standard Chartered Bank//Desktop//Conduct//BAT Mapping")
...
Raw_FMSWData = pd.read_excel(Raw_FMSWData, 'Booking Accuracy Timeliness')
...
output[['Employee PSID', 'Name', 'Dummy']] = Raw_FMSWData['Employee PSID - Name'].str.split("-", expand = True)
output[['LM PSID', 'LM Name']] = Raw_FMSWData['Employee LM'].str.split("-", expand = True)
output['Type of Breach'] = 'Booking Accuracy Timeliness'
...
BAT_Mapping_Output = output
BAT_Mapping_Output.to_excel("BAT_Mapping_Output.xlsx")
