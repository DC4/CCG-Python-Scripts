...
# from BJ import BJ
# from data_breach import data_breach
# from Ops import Ops
# from FLM import FLM
# from data_leakage import data_leakage
# from EOD import EOD
# from PAD import PAD
# from TCIW import TCIW
# from Others import Others

#%%Collect non-FMSW data

# data_breach.columns
data_breach=pd.read_excel(r'C:\Users\1510806\OneDrive - Standard Chartered Bank\Desktop\Conduct_Py_Scripts\Final\Data_Breach_Output.xlsx')
data_breach = data_breach.drop(['Incident ID'], axis=1)
data_leakage=pd.read_excel(r'C:\Users\1510806\OneDrive - Standard Chartered Bank\Desktop\Conduct_Py_Scripts\Final\Data_Leakage_Output.xlsx')
PAD=pd.read_excel(r'C:\Users\1510806\OneDrive - Standard Chartered Bank\Desktop\Conduct_Py_Scripts\Final\PAD_Output.xlsx')
PAD = PAD.drop(['Transaction ID', 'Bank ID', 'Risk Classification', 'Breach Issued on', 'Remarks'], axis=1)
TCIW=pd.read_excel(r'C:\Users\1510806\OneDrive - Standard Chartered Bank\Desktop\Conduct_Py_Scripts\Final\TCIW_Output.xlsx')
TCIW = TCIW.drop(['Staff ID', 'Final Severity Rating', 'Month of Close Date','Breach Description'], axis=1)
FLM=pd.read_excel(r'C:\Users\1510806\OneDrive - Standard Chartered Bank\Desktop\Conduct_Py_Scripts\Final\FLM_Output.xlsx')
EOD=pd.read_excel(r'C:\Users\1510806\OneDrive - Standard Chartered Bank\Desktop\Conduct_Py_Scripts\Final\EOD_Output.xlsx')
BJ=pd.read_excel(r'C:\Users\1510806\OneDrive - Standard Chartered Bank\Desktop\Conduct_Py_Scripts\Final\BJ_Output.xlsx')
Ops=pd.read_excel(r'C:\Users\1510806\OneDrive - Standard Chartered Bank\Desktop\Conduct_Py_Scripts\Final\Ops_Output.xlsx')
Others=pd.read_excel(r'C:\Users\1510806\OneDrive - Standard Chartered Bank\Desktop\Conduct_Py_Scripts\Final\Others_Output.xlsx')
# data_breach.columns
# data_leakage.columns
# G_E.columns
# PAD.columns
# TCIW.columns
# FLM.columns
...
# Ops.columns
# Others.columns
# list_non_fmsw = data_breach.append([data_leakage,G_E,PAD,TCIW,FLM,EOD,BJ,Ops,Others])
...
# Newly included column name modification
# testing_4 = testing_4.set_axis(axis=1,labels=["Employee PSID","Name", "Material breach in 12 months"])
...
# Newly included column name
testing_4.columns=[[('Employee PSID'),('Material breach in 12 months')]]
...
# Newly including renaming of column names
testing = testing.rename(columns={('LM Location',): 'LM Location', ('LM Region',): 'LM Region', ('Material breach in Q',):'Material breach in Q'})
...
testing_3=testing_3[['Employee PSID','Name']]
testing_4.columns=['Employee PSID', 'Name', 'Material breach in 12 months']
# Newly renaming the column
testing = testing.rename(columns={'(Material breach in Q,)': 'Material breach in Q'})
testing_4=testing[['Employee PSID', 'Name']].drop_duplicates().join(testing_4.set_index('Employee PSID'),on='Employee PSID')   
testing_4=testing_4.drop_duplicates()
testing_4.columns=[[('Employee PSID', ''),('Name', ''),('Material breach in 12 months', '')]]
