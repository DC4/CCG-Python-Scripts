...
# FMSWData_12
Raw_FMSWData_12 = pd.ExcelFile('C://Users//1510806//OneDrive - Standard Chartered Bank//Desktop//Conduct//Missed_Trade//FMSWData_12.xlsx')
FMSWData_12 = pd.read_excel(Raw_FMSWData_12, 'Missed Trade')
print("Shape of FMSWData_12:", FMSWData_12.shape)
# Mapping
Raw_Mapping = pd.ExcelFile('C://Users//1510806//OneDrive - Standard Chartered Bank//Desktop//Conduct//Missed_Trade//Mapping.xlsx')
Mapping = pd.read_excel(Raw_Mapping, 'Sheet1')
print("Shape of Mapping:", Mapping.shape)
# Stafflist
Raw_Stafflist = pd.ExcelFile('C://Users//1510806//OneDrive - Standard Chartered Bank//Desktop//Conduct//Missed_Trade//Stafflist.xlsx')
...
Stafflist_Subset = Stafflist[['Bank Id', 'Staff Country', 'Staff Region', 'Business Function Level 6 Desc', 'Role']]
Stafflist_Subset.set_axis(['Employee PSID', 'LM Location', 'LM Region', 'Business (Lvl 6)', 'Role'], axis='columns', inplace=True) 
# Stafflist_Subset.to_excel("Output_Stafflist_Subset.xlsx")
output['Employee PSID'] = output['Employee PSID'].astype(int)
Stafflist_Subset = Stafflist_Subset[Stafflist_Subset['Employee PSID'].isin(output['Employee PSID'])]
output = pd.merge(output, Stafflist_Subset, on="Employee PSID", how="left")
...
Missed_Trade_Output.to_excel("Missed_Trade_Final_Output.xlsx")
