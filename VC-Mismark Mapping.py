...
os.chdir("C://Users//1510806//OneDrive - Standard Chartered Bank//Desktop//Conduct//VC-Mismark Mapping")
...
Raw_FMSWData = pd.read_excel(Raw_FMSWData, 'VC - Mismark')
...
output['Quarter'] = pd.PeriodIndex(Raw_FMSWData['Month-end'], freq='Q')
output['Date'] = Raw_FMSWData['Month-end']
output[['Employee PSID', 'Name']] = Raw_FMSWData['Emp Name'].str.split("-", expand = True)
output[['LM PSID', 'LM Name']] = Raw_FMSWData['LM Name'].str.split("-", expand = True)
output['Type of Breach'] = 'VC - Mismark'
...
output['Material?'] = 'NA'
output['Comment'] = Raw_FMSWData['Justification Comments']
...
Appropriateness_Mapping_Output = output
Appropriateness_Mapping_Output.to_excel("Appropriateness_Mapping_Output.xlsx")
