...
os.chdir("C://Users//1510806//OneDrive - Standard Chartered Bank//Desktop//Conduct//Best Execution")
...
FMSWData_12 = pd.read_excel(Raw_FMSWData_12, 'Best Execution Alerts')
...
output[['Employee PSID', 'Name', 'Dummy']] = FMSWData_12['PSID - Name'].str.split("-", expand = True)
output['Location'] = FMSWData_12['Responsible User\'s Country']
output['Type of Breach'] = 'Best Execution'
output['Sub categories'] = 'Compliance Risk'
output['Severity'] = 'Rag - ' + FMSWData_12['Rag Status']
...
output['Materiality'] = 'Best Execution Rag - RED'
output['Material?'] = 'Material'
output['Comment'] = FMSWData_12['Justification Comments']
...
Best_Ex_Output.to_excel("Best_Ex_Output.xlsx")
