...
os.chdir("C://Users//1510806//OneDrive - Standard Chartered Bank//Desktop//Conduct//FM Surveillance Alerts Mapping")
...
Raw_FMSWData = pd.read_excel(Raw_FMSWData, 'FM Surveillance Alerts')
...
output['Quarter'] = pd.PeriodIndex(Raw_FMSWData['Month of Report'], freq='Q')
output['Date'] = Raw_FMSWData['Month of Report']
output[['Employee PSID', 'Name', 'Dummy']] = Raw_FMSWData['Emp Name'].str.split("-", expand = True)
output['LM PSID'] = Raw_FMSWData['LM PSID']
output['LM Name'] = Raw_FMSWData['LM Name']
output['Type of Breach'] = 'FM Surveillance Alerts'
output['Sub categories'] = 'Compliance Risk'
output['Severity'] = Raw_FMSWData['Fair Accountability Severity Rating']
output['Accountability'] = 'NA'
output['Materiality'] =  output['Type of Breach'] + ' ' + output['Severity']
output['Material?'] = 'NA'
output['Comment'] = Raw_FMSWData['Summary of Issue']
...
cols = ['Dummy', 'LM PSID_y', 'LM Name_y']
...
output.set_axis(['Quarter', 'Date', 'Employee PSID', 'Name', 'LM PSID',
       ...
       'Material?',  'Comment', 'FMSW/non-FMSW', 'Location', 'Region',  'Business (Lvl 6)', 'Role'], axis='columns', inplace=True)
...
output.set_axis(['Quarter', 'Date', 'Employee PSID', 'Name', 'LM PSID',
       ...
       'Accountability', 'Materiality', 'Material?', 'Comment', 'FMSW/non-FMSW',
...
FM_Surveillance_Alerts_Output = output
FM_Surveillance_Alerts_Output.to_excel("FM_Surveillance_Alerts_Output.xlsx")
