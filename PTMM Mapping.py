...
os.chdir("C://Users//1510806//OneDrive - Standard Chartered Bank//Desktop//Conduct//PTMM Mapping")
...
Raw_FMSWData = pd.read_excel(Raw_FMSWData, 'Pre & Post Trade Mid Mark')
...
output['Quarter'] = pd.PeriodIndex(Raw_FMSWData['Deal Date'], freq='Q')
output['Date'] = Raw_FMSWData['Deal Date']
output[['Employee PSID', 'Name', 'Dummy']] = Raw_FMSWData['Sales person Name'].str.split("-", expand = True)
output[['LM PSID', 'LM Name']] = Raw_FMSWData['LM Name'].str.split("-", expand = True)
output['Type of Breach'] = 'PTMM'
output['Sub categories'] = 'Compliance Risk'
output['Severity'] = 'NA'
output['Accountability'] = 'NA'
output['Materiality'] = 'NA'
output['Material?'] = 'non-Material'
output['Comment'] = Raw_FMSWData['Exception']
...
PTMM_Mapping_Output = output
PTMM_Mapping_Output.to_excel("PTMM_Mapping_Output.xlsx")
