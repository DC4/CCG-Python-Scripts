...
os.chdir("C://Users//1510806//OneDrive - Standard Chartered Bank//Desktop//Conduct//Margin Reform Mapping")
...
Raw_FMSWData = pd.read_excel(Raw_FMSWData, 'Margin Reform')
...
output[['LM PSID', 'LM Name']] = Raw_FMSWData['Original FO LM'].str.split("-", expand = True)
output['Type of Breach'] = 'Margin Reform'
output['Sub categories'] = 'Compliance Risk'
output['Severity'] = 'Low'
output['Accountability'] = 'Coaching and Counseling'
output['Materiality'] = 'Margin Reform Low'
...
Margin_Reform_Mapping_Output = output
Margin_Reform_Mapping_Output.to_excel("Margin_Reform_Mapping_Output.xlsx")
