...
# Change to add in new column names
testing_4 = testing_4.set_axis(axis=1,labels=[('Material breach in 12 months', ''),('Employee PSID', ''),('Name', ''),('non-Material breach in 12 months',''), ('Breaches in 12 months','')])
