...
PAD=pd.read_excel(r'C:\Users\1510806\OneDrive - Standard Chartered Bank\Desktop\Conduct_Py_Scripts\Final\PAD.xlsx')
# PAD = PAD.drop(['Transaction ID', 'Bank ID', 'Risk Classification', 'Breach Issued on', 'Remarks'], axis=1)
TCIW=pd.read_excel(r'C:\Users\1510806\OneDrive - Standard Chartered Bank\Desktop\Conduct_Py_Scripts\Final\TCIW.xlsx')
...
testing["LM Region"]=np.where(testing[('LM Location',)]=="United States","Americas",testing[('LM Location',)])
testing["LM Region"]=np.where(testing[('LM Region',)]=="Europe & Americas","Europe",testing[('LM Region',)])
...
# [('non-Material breach in 12 months', '')]="non-Material: "+testing_4[('non-Material breach in 12 months', '')].astype(str)
...
testing_4[(('Breaches in 12 months', ''),)]=np.where(pd.isnull(testing_4[(('non-Material breach in 12 months', ''),)]),testing_4[(('non-Material breach in 12 months', ''),)],testing_4[(('non-Material breach in 12 months', ''),)].astype(str)+"\n"+testing_4[(('non-Material breach in 12 months', ''),)].astype(str))
# testing_4=testing_4[[('Employee PSID', ''),('Name', ''),('Breaches in 12 months','')]]
testing_4 = testing_4.get([('Employee PSID', ''),('Name', ''),('Breaches in 12 months','')])

# testing_4 = testing_4.columns.set_levels(['Material breach in 12 months','Employee PSID','Name','non-Material breach in 12 months','Breaches in 12 months'],level=1,inplace=True)
#%% pivot for employee
