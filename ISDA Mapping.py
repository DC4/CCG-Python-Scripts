...
os.chdir("C://Users//1510806//OneDrive - Standard Chartered Bank//Desktop//Conduct//ISDA Mapping")
...
Raw_FMSWData = pd.read_excel(Raw_FMSWData, 'ISDA Stays')
...
output['Type of Breach'] = 'ISDA Stays'
...
output['Comment'] = Raw_FMSWData['Justification for Disciplinary Action']
...
output.set_axis(['Quarter', 'Date', 'Employee PSID', 'Name', 'LM PSID',
       ...
       'Comment', 'Material?', 'FMSW/non-FMSW', 'Location', 'Region',  'Business (Lvl 6)', 'Role'], axis='columns', inplace=True)
...
output.set_axis(['Quarter', 'Date', 'Employee PSID', 'Name', 'LM PSID',
       ...
       'Accountability', 'Materiality', 'Comment', 'Material?', 'FMSW/non-FMSW',
...
ISDA_Mapping_Output = output
ISDA_Mapping_Output.to_excel("ISDA_Mapping_Output.xlsx")
